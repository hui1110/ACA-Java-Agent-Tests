...
if [ $(az containerapp logs show --name app-$QUARKUS_LOG4J2_RESOURCE_GROUP --resource-group $QUARKUS_LOG4J2_RESOURCE_GROUP --type console --tail 100 | grep "DEBUG" | wc -l) -gt 0 ]
then
